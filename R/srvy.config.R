...
# main program
  ...
  # frame 1 contains parameters
    ...
    frame1.lab.1.1 <- ttklabel(frame1, text="Approximate number of contours")
    frame1.lab.2.1 <- ttklabel(frame1, text="Width of windows device (in)")
    ...
    frame1.lab.6.1 <- ttklabel(frame1, text="Maximum length of vector arrows (in)")
    frame1.lab.7.1 <- ttklabel(frame1, text="Increment vector arrows in x-axis by")
    frame1.lab.8.1 <- ttklabel(frame1, text="Increment vector arrows in y-axis by")
  ...
  # frame 2 contains plot features
    ...
    frame2.chk.2.1 <- ttkcheckbutton(frame2, variable=show.poly.var,   text="show polygons")
    ...
    frame2.chk.6.1 <- ttkcheckbutton(frame2, variable=show.arrows.var, text="show vector arrows")
    frame2.chk.7.1 <- ttkcheckbutton(frame2, variable=vuni.var,        text="use uniform vector arrow lengths")
